...
namespace Thimas.ServiceLocator
{
    public class ServiceLocator : MonoBehaviour
    {
        ...
        const string _globalServiceLocatorName = "ServiceLocator [Global]";
        const string _sceneServiceLocatorName = "ServiceLocator [Scene]";
        ...
        public static ServiceLocator Global
        {
            get
            {
                ...
                var container = new GameObject(_globalServiceLocatorName, typeof(ServiceLocator));
        ...
        {
            var go = new GameObject(_globalServiceLocatorName, typeof(ServiceLocatorGlobal));
        }

        [MenuItem("GameObject/ServiceLocator/Add Scene")]
        static void AddScene()
        {
            var go = new GameObject(_sceneServiceLocatorName, typeof(ServiceLocatorScene));
        }
#endif
    }
}